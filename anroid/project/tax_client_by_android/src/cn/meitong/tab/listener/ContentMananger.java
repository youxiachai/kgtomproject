...
public class ContentMananger implements OnClickListener{
	...
	public void haveQrcoreQuery(){
		activityContent.findViewById(R.id.online_query).setOnClickListener(this);
	}
	//手机号码
...
//			startActivity(smsIntent);
		...
		case R.id.inputphone:
			Log.d("main", "phoneinput");
			 ...
			 intent = setIntent(MainTabActivity.class, null, null, ActionValues.INPUTPHONE);
			activityContent.startActivity(intent);
			break;
		case R.id.inputquery:
			Log.d("main", "inputquery");
			 intent = setIntent(MainTabActivity.class, null, null, ActionValues.INPUTQUERY);
				activityContent.startActivity(intent);
			break;
		case R.id.sms:
//			intent =
			...
			//intent  = new Intent().setClass(activityContent, SMSSendActivity.class);
			//intent.putExtra(ResultValues.SMS_RESULT, smsSend);
			intent = setIntent(MainTabActivity.class, ResultValues.SMS_RESULT, smsSend, ActionValues.SCAN_SMS_SEND);
			//
		...
		//	String queryValues = activityContent.getIntent().getStringExtra(ResultValues.QueryKey.QRCODE);
			...
			String message = queryValues(ResultValues.QueryType.qRcode, queryValues);
	 ...
	 * @return
	 */
	public String queryValues(int type,String queryValues){
		...
		try {
			...
			case ResultValues.QueryType.qRcode:
				InputStream is = activityContent.getAssets().open("qrcode_type.xml");
